...
<table width="100%" border="0" cellspacing="3">
  <tr> 
    <td><!-- <img src="ehslogo2.gif" width="142" height="111" alt="EHS logo" border="0"> removed by CL/Safety and Wellbeing 22/4/09-->&nbsp;</td>
    <td>
      <div align="right"><img src="utslogo.gif" width="135" height="30" alt="UTS logo graphic"></div>
    </td>
  </tr>
  <tr>
    <td colspan="2"><center><font size="+3">*** DRAFT ONLY ***</font></center><br>
      <h2> <b>Health and Safety Service Agreement for the <%=rsAP("dpName")%></b></h2>
      The purpose of this Service Agreement is to document the services that the <%=rsAP("dpName")%> requires from Safety &amp; Wellbeing to assist in the implementation of its Health and Safety Plan.<br><br>
    ...
    <p><font size="1">*Compliance Ratings:<BR>
      ...
      <table border="1" cellpadding="3">
        <tr> 
          ...
          <td><span class="label">SERVICES TO BE PROVIDED BY SAFETY &amp; WELLBEING</span><br>
          </td>
...
%>     
      ...
      <table width="100%" border="0" cellspacing="0" id="table3">
        ...
        <tr>
          <td><h2>Safety &amp; Wellbeing Contact</h2></td>
